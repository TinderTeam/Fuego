...
public class CheckPlanServiceImpl<E> extends TransactionServiceImpl implements TransPlanService<E>
{
	...
	public E createPlan(String user)
	{
		...
		for(SystemUser gasUser : gasUserList)
		{
 			 ...
 			 { 
 				 ...
 				 List<CheckPlan> checkPlanList = convertCheckPlanByBo(trans, planList);
	...
	private List<CheckPlan> convertCheckPlanByBo(TransactionBaseInfoBo trans, List<CheckPlanInfoBo> checkPlanBoList)
	{
		List<CheckPlan> planList = new ArrayList<CheckPlan>();
		for(CheckPlanInfoBo checkPlanBo : checkPlanBoList)
		{	
