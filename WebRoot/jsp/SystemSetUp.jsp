...
<html lang="en">
	...
	<!--公用部分------------------------------>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				<a href="<%=request.getContextPath()%>/Login.do" title="返回主页" class="tip-bottom"><i class="icon-home"></i>Home</a>
				<a href="<%=request.getContextPath()%>/Login.do" class="current">公告栏</a>
			</div>
				...
				<div class="row-fluid">
					<div class="span12 center" style="text-align: center;">					
						<ul class="quick-actions">
							...
							<li>
								<a href="<%=request.getContextPath()%>/CustomerImageInit.do">
