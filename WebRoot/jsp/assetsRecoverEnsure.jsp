					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content">
								...
								<div class="control-group">
									<span class="label label-info">财务资产部2013年8月12日资产处置计划（事务号：ID20130006）</span>
								</div>	
								...
								<div class="form-actions">
											<button type="submit" class="btn btn-success">送审</button>
											<button type="submit" class="btn btn-primary">下载审批表</button>
