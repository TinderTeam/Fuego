...
<body>
	...
	<form action="<%=request.getContextPath()%>/AssetsRecaptureCreate.do" method="post"  >
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="#" class="tip-bottom">实物资产回收</a>				
			</div>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="form-actions">
										<button type="submit" class="btn btn-success" name="submit" value="submit">下一步</button>
