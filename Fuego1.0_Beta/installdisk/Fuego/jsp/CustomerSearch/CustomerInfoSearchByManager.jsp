...
<html>
	...
	<!--公用部分------------------------------>
		...
		<form action="<%=request.getContextPath()%>/CustomerInfoSearchByManager.do" method="post" class="form-horizontal" >
						...
						<!--<div class="widget-box">-->
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered data-table">
									...
									<tbody>
									<logic:iterate id="CustomerNameList" name= "CustomerNameList">    
              							  <tr class="gradeX">
												<td><a href="<%=request.getContextPath()%>/CustomerInfoShow.do?customerIndex=${CustomerNameList.customerIndex}">
